    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('DONOR', 'Donor'), ('VOLUNTEER', 'Volunteer'), ('RECEIVER', 'Receiver'), ('ADMIN', 'Admin')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('availability', models.CharField(choices=[('ONLINE', 'Online'), ('BUSY', 'Busy'), ('OFFLINE', 'Offline')], default='OFFLINE', max_length=20)),
                ('vehicle_type', models.CharField(choices=[('WALK', 'Walk'), ('BIKE', 'Bike'), ('CAR', 'Car')], default='BIKE', max_length=20)),
